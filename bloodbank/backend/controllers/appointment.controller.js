...
module.exports.view_hospital_appointments = (req, res, next) => {
    Appointment.find({ location: req.params.location, "status": "Pending" }, (err, docs) => {
        if (!err) {
            res.send(docs);
        }
        else {
...
module.exports.view_hospital_accepted_appointments = (req, res, next) => {
    Appointment.find({ location: req.params.location, "status": "Accepted" }, (err, docs) => {
        if (!err) {
            res.send(docs);
        }
        else {
...
module.exports.view_hospital_finished_appointments = (req, res, next) => {
    Appointment.find({ location: req.params.location, "status": "Finished" }, (err, docs) => {
        if (!err) {
            res.send(docs);
        }
        else {
...
// to view paticular donor's appointments
module.exports.view_donors_appointments = (req, res, next) => {
    Appointment.find({ donor_id: req.params.donor_id, "status": "Pending" }, (err, docs) => {
        if (!err) {
            res.send(docs);
        }
        else {
...
// to view paticular donor's previous appointments
module.exports.view_donors_accepted_appointments = (req, res, next) => {
    Appointment.find({ donor_id: req.params.donor_id, $or: [{ "status": "Finished" }, { "status": "Accepted" }] }, (err, docs) => {
        if (!err) {
            res.send(docs);
        }
        else {
...
//add appoitment & send mail to donor
...
// get the finish appointment count in admin dashboard
...
module.exports.hospital_appointment_count = (req, res, next) => {
    Appointment.countDocuments({ location: req.params.location, "status": "Pending" }, (err, count) => {
        if (!err) {
            res.json(count)
...
module.exports.hospital_accepted_appointment_count = (req, res, next) => {
    Appointment.countDocuments({ location: req.params.location, "status": "Accepted" }, (err, count) => {
        if (!err) {
            res.json(count)
        }
        else {
...
// get the finished appointment count in hospital dashboard
module.exports.hospital_finished_appointment_count = (req, res, next) => {
    Appointment.countDocuments({ location: req.params.location, "status": "Finished" }, (err, count) => {
        if (!err) {
            res.json(count)
        }
        else {
